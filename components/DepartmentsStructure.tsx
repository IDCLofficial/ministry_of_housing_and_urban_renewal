      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-8">
            ...
            <div className="relative mt-4 rounded-lg overflow-hidden h-[400px] w-full aspect-[1/1] ring-1 ring-gray-200">
              <Image src={content.imageSrc} alt={content.title} width={1280} height={1280} className="object-cover w-full h-full object-[50%_20%]" />
            </div>
