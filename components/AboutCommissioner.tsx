    ...
    <section className="bg-white py-16 lg:py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-10 items-center">
          {/* Left image */}
          <div className="relative aspect-[3/3] w-full overflow-hidden rounded-lg shadow-sm reveal-left animate-delay-100 hover:scale-102 hover:translate-y-6 hover:translate-x-2 hover:shadow-lg transition-all duration-300 delay-500 ease-in-out">
