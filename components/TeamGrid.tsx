    ...
    <section className="bg-white py-14">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center">
        ...
        <div className="mt-6 py-8 gap-6 flex items-start">
          {members.map((m, idx) => (
            <div key={m.id} className={`flex-1 h-[400px] w-[300px] reveal-pop ${['animate-delay-100','animate-delay-200','animate-delay-300','animate-delay-400','animate-delay-500','animate-delay-600'][idx % 6]} hover:scale-105 transition-all duration-300 ease-in-out`}>
